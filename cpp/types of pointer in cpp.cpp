...
int main(){/*
	...
	double i=9;
	 void *ptr= &i;
	 // wild pointer -when a pointer is declaree and not initialized
	 // dangling pointer - when the a pointer whihc is pointing to a memory location that has been deleted;
